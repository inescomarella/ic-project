...
grViz("digraph flowchart {
      ...
      [2]: '1.2.B1 Caso seja selecionado o modelo psi(.)p(var)'
      [3]: '1.2.B2 Gerar modelos de detecção com base nas covariáveis'
      [4]: '1.2.A Caso o seja selecionado o modelo psi(.)p(t), ou psi(.)p(.)'
      [5]: '1.3. Escrever modelo de detecção final'
...
```{r Detection bias hipothesis, eval=FALSE, message=FALSE, warning=FALSE}
