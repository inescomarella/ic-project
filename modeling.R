...
write.table(
  dd.cfm,
  file = "./output/detection-pVar-10x1-llongicaudis.csv",
  sep = ",",
  row.names = TRUE,
  col.names = NA
)
...
write.table(
  importancia.var.cfm,
  file = "./output/detection-covariates-10x1-llongicaudis.csv",
  sep = ",",
  row.names = TRUE,
  col.names = NA
)
...
write.table(
  det.cfm.pred,
  file =
    ".output/detection-persite-10x1-llongicaudis-p(.).csv",
  sep = ",",
  row.names = TRUE,
  col.names = NA
)
...
write.table(
  dd.ocu.cfm,
  file = "./output/occupancy-models-10x1-llongicaudis.csv",
  sep = ",",
  row.names = TRUE,
  col.names = NA
)
...
write.table(
  OCU.importancia.var.cfm,
  file = "./output/occupancy-pVar-10x1-ebarbara.cfm.csv",
  sep = ",",
  row.names = TRUE,
  col.names = NA
)
...
write.table(
  ocu.pred.cfm,
  file = "./output/occupancy-persite-10x1-llongicaudis-p(.)psi(RS3).csv",
  sep = ",",
  row.names = TRUE,
  col.names = NA
)
